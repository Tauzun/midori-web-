...
class MIDORI_EXPORT NetworkManager : public QNetworkAccessManager
{
    Q_OBJECT
...
public:
    ...
    bool rejectedSslErrors(QString host);
    bool ignoredSslErrors(QString host);
