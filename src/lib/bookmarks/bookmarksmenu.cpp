...
void BookmarksMenu::init()
{
    ...
    addAction(QIcon(QStringLiteral(":icons/menu/star.svg")), tr("Bookmark &This Page"), this, &BookmarksMenu::bookmarkPage)->setShortcut(QKeySequence("Ctrl+D"));
    addAction(QIcon(QStringLiteral(":icons/menu/bookmark-all.svg")), tr("Bookmark &All Tabs"), this, &BookmarksMenu::bookmarkAllTabs);
    addAction(QIcon(QStringLiteral(":icons/menu/bookmarks-organize.svg")), tr("Organize &Bookmarks"), this, &BookmarksMenu::showBookmarksManager)->setShortcut(QKeySequence("Ctrl+Shift+O"));
    addSeparator();
...
void BookmarksMenu::refresh()
{
    ...
    const QList<BookmarkItem *> children = mApp->bookmarks()->menuFolder()->children();
