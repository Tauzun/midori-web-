...
class MIDORI_EXPORT BookmarksModel : public QAbstractItemModel
{
    Q_OBJECT
...
class MIDORI_EXPORT BookmarksFilterModel : public QSortFilterProxyModel
{
    Q_OBJECT
...
class MIDORI_EXPORT BookmarksButtonMimeData : public QMimeData
{
    Q_OBJECT
