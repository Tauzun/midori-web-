...
class MIDORI_EXPORT WebPage : public QWebEnginePage
{
    Q_OBJECT

public:
    enum JsWorld {
        // https://doc.qt.io/qt-5/qwebenginescript.html#ScriptWorldId-enum
        jsMainWorldUnSafe = QWebEngineScript::MainWorld,
        jsAppWorldSafe = QWebEngineScript::ApplicationWorld,
        jsUserWorldSafe = QWebEngineScript::UserWorld
    };
    ...
    QVariant execJavaScript(const QString &scriptSource, quint32 worldId = WebPage::jsMainWorldUnSafe, int timeout = 500);
