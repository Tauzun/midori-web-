...
{
    const QUrl url = QUrl::fromEncoded(map.value(QStringLiteral("url")).toString().toUtf8());
    const Qz::BrowserWindowType type = Qz::BrowserWindowType(map.value(QStringLiteral("type"), QmlEnums::NewWindow).toInt());
