...
{
    const char *url = "org.browser.bhawk";
    ...
    // Bookmarks
    qmlRegisterUncreatableType<QmlBookmarkTreeNode>(url, majorVersion, minorVersion, "BookmarkTreeNode", QStringLiteral("Unable to register type: BookmarkTreeNode"));
    ...
    // TopSites
    qmlRegisterUncreatableType<QmlMostVisitedUrl>(url, majorVersion, minorVersion, "MostVisitedURL", QStringLiteral("Unable to register type: MostVisitedURL"));
    ...
    // History
    qmlRegisterUncreatableType<QmlHistoryItem>(url, majorVersion, minorVersion, "HistoryItem", QStringLiteral("Unable to register type: HistoryItem"));
    ...
    // Tabs
    qmlRegisterUncreatableType<QmlTab>(url, majorVersion, minorVersion, "Tab", QStringLiteral("Unable to register type: Tab"));
    ...
    // Windows
    qmlRegisterUncreatableType<QmlWindow>(url, majorVersion, minorVersion, "Window", QStringLiteral("Unable to register type: Window"));
    ...
    // Menu
    qmlRegisterUncreatableType<QmlMenu>(url, majorVersion, minorVersion, "Menu", QStringLiteral("Unable to register type: Menu"));

    // Action
    qmlRegisterUncreatableType<QmlAction>(url, majorVersion, minorVersion, "Action", QStringLiteral("Unable to register type: Action"));

    // WebHitTestResult
    qmlRegisterUncreatableType<QmlWebHitTestResult>(url, majorVersion, minorVersion, "WebHitTestResult", QStringLiteral("Unable to register type: WebHitTestResult"));

    // Settings
    qmlRegisterType<QmlSettings>(url, majorVersion, minorVersion, "Settings");

    // Qz::Objects
    qmlRegisterUncreatableType<QmlQzObjects>(url, majorVersion, minorVersion, "QzObjects", QStringLiteral("Unable to register type: QzObjects"));

    // KeyEvents
    qmlRegisterUncreatableType<QmlKeyEvent>(url, majorVersion, minorVersion, "KeyEvent", QStringLiteral("Unable to register type: KeyEvent"));

    // MouseEvents
    qmlRegisterUncreatableType<QmlMouseEvent>(url, majorVersion, minorVersion, "MouseEvent", QStringLiteral("Unable to register type: MouseEvent"));

    // WheelEvents
    qmlRegisterUncreatableType<QmlWheelEvent>(url, majorVersion, minorVersion, "WheelEvent", QStringLiteral("Unable to register type: WheelEvent"));
    ...
    qmlRegisterUncreatableType<QmlWebEngineUrlRequestJob>(url, majorVersion, minorVersion, "WebEngineUrlRequestJob", QStringLiteral("Unable to register type: WebEngineUrlRequestJob"));
    ...
    qmlRegisterUncreatableType<QmlEnums>(url, majorVersion, minorVersion, "Enums", QStringLiteral("Unable to register type: Enums"));
}
