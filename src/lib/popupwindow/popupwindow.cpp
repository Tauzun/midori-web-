    ...
    , m_search(0)
{
    ...
    menuFile->addAction(QIcon(QStringLiteral(":icons/menu/mail-message-new.svg")), tr("Send Link..."), m_view, &WebView::sendPageByMail);
    menuFile->addAction(QIcon(QStringLiteral(":icons/menu/document-print.svg")), tr("&Print..."), m_view, &WebView::printPage)->setShortcut(QKeySequence("Ctrl+P"));
    menuFile->addSeparator();
    menuFile->addAction(QIcon(QStringLiteral(":icons/menu/window-close.svg")), tr("Close"), this, &QWidget::close)->setShortcut(QKeySequence("Ctrl+W"));
    ...
    m_menuEdit->addAction(QIcon(QStringLiteral(":icons/menu/search-icon.svg")), tr("Find"), this, &PopupWindow::searchOnPage)->setShortcut(QKeySequence("Ctrl+F"));
    m_menuBar->addMenu(m_menuEdit);

    m_menuView = new QMenu(tr("View"));
    m_actionStop = m_menuView->addAction(QIcon(QStringLiteral(":icons/menu/process-stop.svg")), tr("&Stop"), m_view, &QWebEngineView::stop);
    m_actionStop->setShortcut(QKeySequence("Esc"));
    m_actionReload = m_menuView->addAction(QIcon(QStringLiteral(":icons/menu/view-refresh.svg")), tr("&Reload"), m_view, &QWebEngineView::reload);
    m_actionReload->setShortcut(QKeySequence("F5"));
    m_menuView->addSeparator();
    m_menuView->addAction(QIcon(QStringLiteral(":icons/menu/zoom-in.svg")), tr("Zoom &In"), m_view, &WebView::zoomIn)->setShortcut(QKeySequence("Ctrl++"));
    m_menuView->addAction(QIcon(QStringLiteral(":icons/menu/zoom-out.svg")), tr("Zoom &Out"), m_view, &WebView::zoomOut)->setShortcut(QKeySequence("Ctrl+-"));
    m_menuView->addAction(QIcon(QStringLiteral(":icons/menu/zoom-original.svg")), tr("Reset"), m_view, &WebView::zoomReset)->setShortcut(QKeySequence("Ctrl+0"));
    m_menuView->addSeparator();
    m_menuView->addAction(QIcon(QStringLiteral(":icons/menu/text-html.svg")), tr("&Page Source"), m_view, &WebView::showSource)->setShortcut(QKeySequence("Ctrl+U"));
...
{
    setWindowTitle(tr("%1").arg(m_view->title())); // Removed application name
}
