    ...
    , m_bookmarksManager(new BookmarksManager(window))
{
    ...
    QIcon historyIcon;
    historyIcon.addFile(QStringLiteral(":/icons/other/bighistory.svg"), QSize(), QIcon::Normal);
    historyIcon.addFile(QStringLiteral(":/icons/other/bighistory-selected.svg"), QSize(), QIcon::Selected);

    QIcon bookmarksIcon;
    bookmarksIcon.addFile(QStringLiteral(":/icons/other/bigstar.svg"), QSize(), QIcon::Normal);
    bookmarksIcon.addFile(QStringLiteral(":/icons/other/bigstar-selected.svg"), QSize(), QIcon::Selected);
