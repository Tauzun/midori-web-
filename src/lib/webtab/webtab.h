...
class MIDORI_EXPORT WebTab : public QWidget
{
    Q_OBJECT
public:
    struct MIDORI_EXPORT SavedTab {
        QString title;
        QUrl url;
        QIcon icon;
        QByteArray history;
        ...
        friend MIDORI_EXPORT QDataStream &operator<<(QDataStream &stream, const SavedTab &tab);
        friend MIDORI_EXPORT QDataStream &operator>>(QDataStream &stream, SavedTab &tab);
    };
