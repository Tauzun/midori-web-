...
class MIDORI_EXPORT BrowserWindow : public QMainWindow
{
    Q_OBJECT
...
public:
    struct SavedWindow {
        ...
        friend MIDORI_EXPORT QDataStream &operator<<(QDataStream &stream, const SavedWindow &window);
        friend MIDORI_EXPORT QDataStream &operator>>(QDataStream &stream, SavedWindow &window);
    };
