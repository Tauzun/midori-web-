...
void AutoFillWidget::setUsernames(const QStringList &usernames)
{
    ...
    for (const QString &username : usernames) {
        ...
        button->setIcon(QIcon(QStringLiteral(":icons/other/login.png")));
        button->setStyleSheet(QStringLiteral("text-align:left;font-weight:bold;"));
        ...
        connect(button, &QPushButton::clicked, this, [=]() {
            ...
            if (entry.isValid()) {
                ...
                m_view->page()->runJavaScript(Scripts::completeFormData(entry.data), WebPage::jsAppWorldSafe);
            }
            close();
        });
    }
