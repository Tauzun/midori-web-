...
#define MIMETYPE QStringLiteral("application/bhawk.tabbar.tab")
    ...
    , m_forceHidden(false)
{
    ...
    if (mApp->isPrivate()) {
        ...
        privateBrowsing->setObjectName(QStringLiteral("avatar"));
        privateBrowsing->setPixmap(IconProvider::avatarIcon().pixmap(16));
