...
class MIDORI_EXPORT ComboTabBar : public QWidget
{
    Q_OBJECT
...
class MIDORI_EXPORT TabBarHelper : public QTabBar
{
    Q_OBJECT
...
class MIDORI_EXPORT TabScrollBar : public QScrollBar
{
    Q_OBJECT
public:
...
class MIDORI_EXPORT TabBarScrollWidget : public QWidget
{
    Q_OBJECT
public:
