...
void TabWidget::aboutToShowClosedTabsMenu()
{
    ...
    if (m_menuClosedTabs->isEmpty()) {
        ...
        m_menuClosedTabs->addAction(QIcon(QStringLiteral(":icons/menu/tab-restore.svg")), tr("Restore All Closed Tabs"), this, &TabWidget::restoreAllClosedTabs);
        m_menuClosedTabs->addAction(QIcon(QStringLiteral(":icons/menu/edit-clear.svg")), tr("Clear list"), this, &TabWidget::clearClosedTabsList);
    }
}
