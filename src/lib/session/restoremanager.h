...
struct MIDORI_EXPORT RestoreData
{
    ...
    friend MIDORI_EXPORT QDataStream &operator<<(QDataStream &stream, const RestoreData &data);
    friend MIDORI_EXPORT QDataStream &operator>>(QDataStream &stream, RestoreData &data);
};

class MIDORI_EXPORT RestoreManager
{
public:
