    ...
    QPainter* p, const QWidget* widget) const
{
    ...
    if (widget) {
        const QString fader_key = QStringLiteral("tab_") + text + QStringLiteral("_fader");
        const QString animation_key = QStringLiteral("tab_") + text + QStringLiteral("_animation");
...
class MIDORI_EXPORT FancyColorButton : public QWidget
{
public:
