...
void LineEdit::init()
{
    ...
    QAction* undoAction = new QAction(QIcon(QStringLiteral(":icons/menu/edit-undo.svg")), tr("&Undo"), this);
    ...
    QAction* redoAction = new QAction(QIcon(QStringLiteral(":icons/menu/edit-redo.svg")), tr("&Redo"), this);
    ...
    QAction* copyAction = new QAction(QIcon(QStringLiteral(":icons/menu/edit-copy.svg")), tr("&Copy"), this);
    ...
    QAction* pasteAction = new QAction(QIcon(QStringLiteral(":icons/menu/edit-paste.svg")), tr("&Paste"), this);
...
QMenu* LineEdit::createContextMenu()
{
    ...
    popup->setObjectName(QStringLiteral("qt_edit_menu"));
