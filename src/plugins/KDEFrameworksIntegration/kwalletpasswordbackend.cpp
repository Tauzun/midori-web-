...
void KWalletPasswordBackend::removeAll()
{
    ...
    m_wallet->removeFolder("Bhawk");
    m_wallet->createFolder("Bhawk");
}
...
void KWalletPasswordBackend::initialize()
{
    ...
    bool migrate = !m_wallet->hasFolder("Bhawk") && m_wallet->hasFolder("QupZilla");

    if (!m_wallet->hasFolder("Bhawk") && !m_wallet->createFolder("Bhawk")) {
        qWarning() << "KWalletPasswordBackend::initialize Cannot create folder \"Bhawk\"!";
        return;
    }
    ...
    if (migrate) {
        ...
        if (!m_wallet->setFolder("Bhawk")) {
            qWarning() << "KWalletPasswordBackend::initialize Cannot set folder \"Bhawk\"!";
            return;
        }
    }
