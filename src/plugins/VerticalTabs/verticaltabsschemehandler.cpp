...
{
    QString page = QzTools::readAllFileContents(QStringLiteral(":verticaltabs/data/index.html"));

    page.replace(QStringLiteral("%NAME%"), tr("Vertical Tabs"));
...
{
    QString page = QzTools::readAllFileContents(QStringLiteral(":verticaltabs/data/group.html"));

    page.replace(QStringLiteral("%FAVICON%"), QzTools::pixmapToDataUrl(QIcon(QStringLiteral(":verticaltabs/data/group.svg")).pixmap(16)).toString());
    page.replace(QStringLiteral("%NEW-GROUP%"), tr("New Group"));
