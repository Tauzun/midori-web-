;;;;English
!define PRODUCT_DESC  "Midori Browser is a new and very fast Qt web browser. Falkon is licensed under GPL version 3 or (at your option) any later version. It is based on QtWebEngine and Qt Framework."
...
!define DESC_SecExtensions "Associate Midori with .htm(l) files"
!define DESC_SecThemes "Additional themes for Midori"
!define DESC_SecSetASDefault "Set Midori as default internet browser"
!define DESC_SecProtocols "Associate Midori with http(s) and ftp protocols"

!define DESC_InstallationMode "Select installation mode"
!define DESC_PortableInstallation "Midori will be installed as a 'Portable Application' to the selected location."
!define DESC_StandardInstallation "Midori will be installed on your computer."
!define DESC_InstallInfo "To start installation click 'install'."

!define MSG_RunningInstance "Midori is already running! Do you want the installer try to terminate it?"
!define MSG_InstallationCanceled "Process cancelled by user."
!define MSG_InvalidInstallPath "Install path invalid!"

!define MSG_PortableWriteError "Error occurred when creating 'midori.conf' in installation folder. Create it manually."

!define MSG_HotfixNeeded "To run Midori you have to install hotfix 'KB2999226'. Proceed to Windows update website?"
