...
QmlTestHelper::QmlTestHelper()
{
    ...
    qmlRegisterType<QmlTestItem>("org.browser.bhawk.test", 1, 0, "TestItem");
    QQmlComponent component(&engine);
    component.setData("import org.browser.bhawk 1.0 as bhawk\n"
                      "import org.browser.bhawk.test 1.0 as BhawkTest\n"
                      "import QtQuick 2.7\n"
                      "BhawkTest.TestItem {"
